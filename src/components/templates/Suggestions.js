                ...
                <div className="flex-initial flex flex-row justify-between items-center">
                    <div className="flex-1 border-gray-700 max-w-xs border rounded-lg p-5 m-2">
                        ...
                        <div className="flex flex-col justify-center items-center">
                            <div className="my-5 bg-gray-700 p-3 h-20 w-20 rounded-full">
                                <img
                                    className="rounded-full content-cover" 
                                    alt="Brand"
                                    src={this.state.image} />
                            </div>
                            <h4 className="text-white font-medium text-md">Lorem Ipsum</h4>
